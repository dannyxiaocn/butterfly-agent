...
| `openai_agent` | OpenAI-based coding / reasoning specialist inheriting the default stack | active provider variant |
...
- Provider variants (`kimi_agent`, `openai_agent`) are intentionally thin wrappers over `agent`.
